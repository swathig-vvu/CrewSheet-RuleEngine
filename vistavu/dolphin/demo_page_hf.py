...
class DOLPHIN:
    def __init__(self, model_id_or_path):
        ...
        self.processor = AutoProcessor.from_pretrained(model_id_or_path, device_map="auto", use_fast=True)
        self.model = VisionEncoderDecoderModel.from_pretrained(model_id_or_path, device_map="auto")
        self.model.eval()
        ...
        if self.device == "cuda":
            ...
            print("Using Apple Silicon GPU (MPS) with float16 precision.")
        else:
